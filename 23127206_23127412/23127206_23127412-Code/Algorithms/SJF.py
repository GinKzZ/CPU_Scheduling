...
def SJF(listOfProcess):
	...
	while True:
		...
		#for adding R to CPU, add at next second
		if flagUseR1 == False:
			if len(q_R1) != 0:
		...
		#for adding R to CPU, add in next second
		if flagUseR2 == False:
			if len(q_R2) != 0:
...
def SJF_solve(listOfProcess):
	listOfProcess, listOfCPU, listOfR = SJF(listOfProcess)
